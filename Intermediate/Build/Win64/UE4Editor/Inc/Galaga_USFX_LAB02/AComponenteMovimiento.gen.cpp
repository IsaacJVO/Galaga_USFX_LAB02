...
#include "Galaga_USFX_LAB02/AComponenteMovimiento.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_LAB02_API UClass* Z_Construct_UClass_UAComponenteMovimiento_NoRegister();
	GALAGA_USFX_LAB02_API UClass* Z_Construct_UClass_UAComponenteMovimiento();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_limiteInferiorY_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_limiteInferiorY;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAComponenteMovimiento_Statics::NewProp_limiteInferiorY_MetaData[] = {
		{ "ModuleRelativePath", "AComponenteMovimiento.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAComponenteMovimiento_Statics::NewProp_limiteInferiorY = { "limiteInferiorY", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAComponenteMovimiento, limiteInferiorY), METADATA_PARAMS(Z_Construct_UClass_UAComponenteMovimiento_Statics::NewProp_limiteInferiorY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAComponenteMovimiento_Statics::NewProp_limiteInferiorY_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAComponenteMovimiento_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAComponenteMovimiento_Statics::NewProp_limiteInferiorY,
	};
	...
	IMPLEMENT_CLASS(UAComponenteMovimiento, 4045870716);
	template<> GALAGA_USFX_LAB02_API UClass* StaticClass<UAComponenteMovimiento>()
	{
		return UAComponenteMovimiento::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAComponenteMovimiento(Z_Construct_UClass_UAComponenteMovimiento, &UAComponenteMovimiento::StaticClass, TEXT("/Script/Galaga_USFX_LAB02"), TEXT("UAComponenteMovimiento"), false, nullptr, nullptr, nullptr);
